-- Create Trainers table with all required columns
-- Run this script if the Trainers table doesn't exist yet
...
CREATE TABLE [dbo].[Trainers] (
    ...
    [UpdatedBy] INT NULL,
    CONSTRAINT [FK_Trainers_Province] FOREIGN KEY ([ProvinceId]) 
        REFERENCES [dbo].[Provinces]([Id]) ON DELETE SET NULL
);
...
PRINT 'Trainers table created successfully!';
